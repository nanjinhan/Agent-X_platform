// cult-ui — GradientHeading (nolly-studio/cult-ui, registry/default/ui/gradient-heading.tsx)
// Radix Slot(createContext)을 쓰므로 클라이언트 컴포넌트로 강제 (서버 컴포넌트에서 렌더 시 필요).
"use client"
...
export type Variant = "default" | "pink" | "light" | "secondary" | "brand"
export type Size =
  | "default"
  | "xxs"
  | "xs"
